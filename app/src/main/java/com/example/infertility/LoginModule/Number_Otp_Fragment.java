 ...
 * Use the {@link Number_Otp_Fragment#newInstance} factory method to
...
public class Number_Otp_Fragment extends Fragment {
     ...
     * @return A new instance of fragment Number_Otp_Fragment.
     */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        cardViewBackButtonOtp.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        Button btnSubmit = rootView.findViewById(R.id.btnSubmitOtp);
